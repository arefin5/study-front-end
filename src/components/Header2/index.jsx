  ...
  return (
    <>
      <header className={props.className}>
        <Img
          className="h-[257px] sm:h-auto object-cover w-full"
          src="images/img_rectangle_257x1440.png"
          alt="rectangle"
        />
        <div className="bg-blue_gray-900_90 flex flex-col gap-12 items-center justify-start pb-[51px] w-full">
