        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-segoeui gap-[15px] items-start justify-between max-w-[1418px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col font-inter justify-start md:mt-0 mt-[70px] w-[77%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[23px] mt-[82px] w-[86%] md:w-full">
                <Text
                  className="mb-1.5 sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center"
                  size="txtInterSemiBold40"
                >
                  Kanji
                </Text>
                <Text
                  className="mb-1.5 md:ml-[0] ml-[153px] sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center"
                  size="txtInterSemiBold40"
                >
                  Reading
                </Text>
                <Text
                  className="ml-32 md:ml-[0] md:mt-0 mt-1.5 sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center"
                  size="txtInterSemiBold40"
                >
                  Mening
                </Text>
                <Text
                  className="md:ml-[0] ml-[113px] md:mt-0 my-[3px] sm:text-4xl md:text-[38px] text-[40px] text-black-900 text-center"
                  size="txtInterSemiBold40"
                >
                  Details
                </Text>
              ...
              <div className="flex flex-col mt-[31px] relative w-full">
                <Img
                  className="h-[215px] mx-auto object-cover w-full"
                  src="images/img_screenshot91.png"
                  alt="screenshotNinetyOne"
                />
                <div className="flex flex-col items-center justify-start mt-[-123px] mx-auto w-[98%] z-[1]">
                  <div className="bg-white-A700 flex flex-col items-center justify-end p-[49px] md:px-10 sm:px-5 rounded-[16px] shadow-bs1 w-full">
                    <Img
                      className="h-[292px] md:h-auto mt-[7px] object-cover w-[86%]"
                      src="images/img_screenshot101.png"
                      alt="screenshot101"
                    />
                  </div>
                </div>
